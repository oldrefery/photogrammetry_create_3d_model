...
DOCKER_MEMORY=$((AVAILABLE_MEMORY * 80 / 100)) # use 80% available memory
DOCKER_MEMORY_SWAP=$((DOCKER_MEMORY * 4)) # swap is twice of main memory
...
echo "Docker memory SWAP limit: ${DOCKER_MEMORY_SWAP}GB"
